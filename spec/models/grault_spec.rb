...
RSpec.describe Grault, :type => :model do
  ...
  it "can create lots of Graults h" do
    ...
    assert_equal(5000, Grault.where(name: "h").count)
  end
  it "can create lots of Graults i" do
    (1..5000).each do |n|
      Grault.create(name: "i")
    end
    assert_equal(5000, Grault.where(name: "i").count)
  end
  it "can create lots of Graults j" do
    (1..5000).each do |n|
      Grault.create(name: "j")
    end
    assert_equal(5000, Grault.where(name: "j").count)
  end
end
